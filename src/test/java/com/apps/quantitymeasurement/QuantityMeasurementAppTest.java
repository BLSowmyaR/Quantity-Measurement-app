...
public class QuantityMeasurementAppTest {
    ...
    public void testConversion_YardsToInches() {
        assertEquals(36.0, QuantityMeasurementApp.convert(1.0, Length.LengthUnit.YARDS, Length.LengthUnit.INCHES),
                1e-6);
    }

    @Test
    public void testConversion_InchesToYards() {
        assertEquals(2.0, QuantityMeasurementApp.convert(72.0, Length.LengthUnit.INCHES, Length.LengthUnit.YARDS),
                1e-6);
    }
    ...
    public void testConversion_RoundTrip_PreservesValue() {
        ...
        double feetToInches = QuantityMeasurementApp.convert(originalValue, Length.LengthUnit.FEET,
                Length.LengthUnit.INCHES);
        double roundTrip = QuantityMeasurementApp.convert(feetToInches, Length.LengthUnit.INCHES,
    ...
    public void testConversion_NegativeValue() {
        assertEquals(-12.0, QuantityMeasurementApp.convert(-1.0, Length.LengthUnit.FEET, Length.LengthUnit.INCHES),
                1e-6);
    }
